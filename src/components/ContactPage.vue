<template>
  <div class="py-[96px] px-[80px]">
    <div class="bg-[#E5E7EB] rounded-full px-6 py-2 mb-[16px] inline-block">
      <p>get in touch</p>
    </div>
    <p class="text-xl w-1/2 mx-auto">What’s next? Feel free to reach out to me if you're looking for a developer, have a query, or simply want to connect.</p>
    <div class="py-[48px] text-2xl font-semibold">
      <div class="flex justify-center">
        <svg class="pt-[4px]" xmlns="http://www.w3.org/2000/svg" width="24" height="32" viewBox="0 0 32 24">
          <g fill="none" stroke="#4b5563" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
            <rect width="20" height="16" x="2" y="4" rx="2" />
            <path d="m22 7l-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
          </g>
        </svg>
        <p class="ps-1">pasifica27@gmail.com</p>
      </div>
      <div class="flex justify-center pt-4">
        <svg class="" xmlns="http://www.w3.org/2000/svg" width="24" height="32" viewBox="0 0 256 256">
          <path
            fill="#4b5563"
        ...
        <p class="ps-1">085159095311</p>
      </div>
    </div>
    <div>
      <p class="text-lg">You may also find me on these platforms!</p>
